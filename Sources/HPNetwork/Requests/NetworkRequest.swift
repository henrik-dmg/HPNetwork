...
extension NetworkRequest {
    ...
    /// - Throws: Throws an error when anything went wrong while executing the network request
    @discardableResult
    public func response(urlSession: URLSession) async throws -> Response {
